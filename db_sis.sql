...
--
-- Table structure for table `tabel_kritik`
--
...
--
-- Dumping data for table `tabel_kritik`
--

INSERT INTO `tabel_kritik` (`id_kritik`, `id_user`, `kritik`, `tanggal_posting`, `tanggal_respon`, `respon`) VALUES
(1, 6, 'Menggoda', '2023-04-09 14:29:53', '2023-04-10 19:30:31', 'Sial aku tergoda'),
(2, 6, '<p>Aku Juga maw :b</p>\r\n', '2023-04-09 19:15:07', NULL, '');
...
(1, 6, '<p><big>Menggoda</big></p>\r\n', '2023-04-09 19:13:13', NULL, ''),
(2, 6, '<p>Kerja <var><strong>Bagus</strong></var></p>\r\n', '2023-04-09 19:19:39', NULL, ''),
(3, 6, '<p>Sebaik Jangan <cite><s>Gegabah</s></cite></p>\r\n', '2023-04-09 19:20:09', '2023-04-11 00:20:35', 'Baiklah'),
(4, 6, '<p>halo dick</p>\r\n', '2023-04-09 20:26:03', NULL, '');
...
CREATE TABLE `tabel_testimoni` (
  ...
  `pesan` varchar(2295) DEFAULT NULL,
  `tampil` varchar(2295) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `tabel_kritik`
--
ALTER TABLE `tabel_kritik`
...
--
-- AUTO_INCREMENT for table `tabel_kritik`
--
ALTER TABLE `tabel_kritik`
  MODIFY `id_kritik` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tabel_saran`
  MODIFY `id_saran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
