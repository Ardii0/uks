                            ...
                            <div class="col-12">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="mb-3" >
                                            <span <?php if (tampil_tetapkan_byid($this->session->userdata('id_rn')) == 1) echo "class='hidden''" ?>>
                                         <a href="#myModal" class="trash" data-id="<?php echo $this->session->userdata("id_level") ?>" >       
                                        ...
                                        <a href="#myModal" class="trash" data-id="<?php echo $this->session->userdata("id_level") ?>" >       
                                            ...
                                            <button class="btn btn-success" onclick="tetapkan(<?php echo $this->session->userdata("id_rn") ?>)">
                                                <i class="fa fa-download pr-2"></i>
                                                Tetapkan
                                            </button>
                                            </span>
                                            <span <?php if (tampil_tetapkan_byid($this->session->userdata('id_rn')) == 1) echo "class='shis''"; else if (tampil_tetapkan_byid($this->session->userdata('id_rn')) == 0) echo "class='hidden''"; ?>>
                                            <div class="mb-3" >
