            ...
            <section class="content">
                <div class="container-fluid bg-white shadow p-3">
                    <div class="row">
                        ...
                        <?php echo form_open('Keuangan/direct_cari', array('class' => 'col-6', 'id' => 'form')); ?>
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <select id="kelas" class="custom-select custom-select-md">
                                    ...
                                    <option value="<?php echo $kelas->id_kelas ?>"><?php echo $kelas->nama_kelas ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-8">
                                <select id="rombel" class="custom-select custom-select-md">
                                    ...
                                    <option value="<?php echo $rombel->id_rombel ?>"><?php echo $rombel->nama_rombel ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="col-8">
                                <select name="id_siswa" id="siswa" class="custom-select custom-select-md">
                                    ...
                                    <option value="<?php echo $siswa->id_siswa ?>">
                                        <?php echo tampil_namadaftar_ByIdSiswa($siswa->id_siswa) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class=" col-12 mt-3">
                            <?php foreach ($siswa_hasil as $siswas): ?>
                            <div class="text-center font-weight-bold h3">
                                <div>
                                    <?php echo tampil_kelasById(tampil_id_kelas_rombel_byid ($siswas->id_rombel)) ;?>
                                    <?php echo tampil_rombel_byid($siswas->id_rombel) ;?>
                                </div>
                                <?php echo tampil_namadaftar_ByIdSiswa($siswas->id_siswa) ;?>
                            </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        html += '<option value=' + data[i].id_rombel + '>' + data[i]
                            .nama_rombel + '</option>';
                    }
                    $('#rombel').html(html);
        ...
        $('#rombel').change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        html += '<option value=' + data[i].id_siswa + '>' + data[i].nama +
                            '</option>';
                    }
                    $('#siswa').html(html);
