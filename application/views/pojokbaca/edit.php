                ...
                <div class="container-fluid mb-4">
                    <div class="header p-1 text-light rounded-top d-flex justify-content-between"
                        ...
                        <div class="p-2 d-flex align-items-center gap-3">
                            <div style="font-size: 1.5rem">Edit Buku</div>
                        </div>
                    </div>

                    <div class="bg-light shadow">
                        <section class="content bg-white p-3 rounded">
                            <form action="<?php echo base_url('pojokbaca/aksi_edit_buku/' . $buku['id_buku']) ?>"
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" name="judul_buku" class="form-control"
                                                value="<?php echo $buku['judul_buku'] ?>" required><br>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group ">
                                                ...
                                                <div class="">
                                                    <input type="text" name="penerbit_buku" class="form-control"
                                                        value="<?php echo $buku['penerbit_buku'] ?>" required><br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group ">
                                                ...
                                                <div class="">
                                                    <input type="text" name="penulis_buku" class="form-control"
                                                        value="<?php echo $buku['penulis_buku'] ?>" required><br>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group ">
                                                ...
                                                <div class="">
                                                    <input type="number" name="tahun_terbit" class="form-control"
                                                        value="<?php echo $buku['tahun_terbit'] ?>" required><br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col form-group">
                                            ...
                                            <div class="">
                                                <input type="text" name="sumber" class="form-control"
                                                    value="<?php echo $buku['sumber'] ?>" required><br>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col form-group">
                                            ...
                                            <div>
                                                <img src="<?php $img = $buku['foto'] == null ? "" : base_url('uploads/pojokbaca/buku') . "/" . $buku['foto'];
                                    ...
                                    <div class="box-footer d-flex justify-content-between">
                                        <button class="btn btn-danger text-bold mr-2" type="button"
                                            onclick="kembali()"><span class="p-3">Batal</span></button>
