                        ...
                        <div class="">
                            ...
                            <div class="header p-1 text-light rounded-top d-flex justify-content-between" style="background-color:#4ADE80">
                                    ...
                                    <div class="p-2 d-flex align-items-center gap-3">
                                        ...
                                        <button data-toggle="modal" data-target="#modal_tambah_tindakan" class="btn btn-info rounded bg-sky-600"><i
                                                    class="fas fa-plus"></i>&nbsp;
                                                Tambah</button>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo base_url('Tindakan/edit_tindakan/' . $data->id) ?>" class="btn btn-warning btn-sm" >
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group col-sm-12 mb-0">
                                    ...
                                    <div class="">
                                        ...
                                        required placeholder="Masukan Nama Tindakan"><br>
                                    </div>
                                </div>
                                <!-- </div> -->
                            </div>
