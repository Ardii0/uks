            ...
            <div class="container-fluid">
                <div class="px-3 py-1">
                    ...
                    <div class="bg-white shadow container px-5 py-3 rounded-lg">
                        ...
                        <form action="<?php echo base_url('Alumni/update_akun') ?>" enctype="multipart/form-data"
                            method="post">
                            <div class="row">
                                ...
                                <div class="col-12 row mt-3">
                                    ...
                                    <div class="col-9">
                                        <input type="password" id="remove" name="password_baru"
                                ...
                                <div class="col-12 row mt-3">
                                    ...
                                    <div class="col-9">
                                        <input type="password" id="remove" name="password_baru2"
                                            class="form-control w-100">
                                    </div>
                                </div>
                                <div class="col-12 row mt-3">
                                    <div class="col-3 font-weight-bold mt-1">Foto</div>
                                    <div class="col-9">
                                        <input type="file" name="foto" onchange="readURL(this);" />
                                        <div class="row mt-1">
                                            <div class="col-6">
                                                <div>Foto Sebelum:</div>
                                                <img src="<?php echo base_url('uploads/alumni/akun')."/".$data->foto;?>"
                                                    style="width: 110px; hight:200px" class="mt-3" />
                                            </div>
                                            <div class="col-6">
