                                        ...
                                        <form action="<?php echo base_url('inventaris/ubah_invent') ?>" method="post">
                                            <div class="box-body">
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-">
                                                        <input type="text" value="<?php echo $datas->nama_barang ?>"
                                                            name="nama_barang" required="" class="form-control"><br>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-12">
                                                    <label class="col-sm-2 control-label">Pendanaan</label>
                                                    <div class="col-sm-">
                                                        <input type="text" value="<?php echo $datas->pendanaan ?>"
                                                            name="pendanaan" required="" class="form-control"><br>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-">
                                                        <input type="date"
                                                            value="<?php echo $datas->tgl_barang_masuk ?>"
                                                            name="tgl_barang_masuk" required=""
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="col-sm-">
                                                        <input type="number" value="<?php echo $datas->jumlah_barang ?>"
                                                            name="jumlah_barang" required="" class="form-control"><br>
                                                    </div>
                                                </div>
