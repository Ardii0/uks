                                ...
                                <div class="card-body text-center">
                                    <div class="d-flex flex-column align-items-center">
                                        <img style="width: 190px; height:190px;"
                                            src="<?php echo $datas->foto == null ? base_url('uploads/data/default_profile/logo_profil.png') : base_url('uploads/data/data_karyawan')."/".$datas->foto ?>"
                                            alt="Foto karyawan" class="rounded-circle" width="150">
                                    </div>
                                    <div class="mt-4">
                                        <h4><?php echo $datas->nama_karyawan ?></h4>
                                        <hr class="mt-2">
                                        <hr class="mt-2">
                                    ...
                                    <a class="btn btn-warning text-white text-bold w-100 mt-1 d-flex align-items-center justify-content-center"
                                        style="height: 47px"
                                        href="<?php echo base_url('data/edit_karyawan/' . $datas->id)?>">Edit
                                        Data karyawan</a>
                                </div>
                            </div>
                        </div>
