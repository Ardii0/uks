...
<head>
    ...
    <title>Penanganan Pertama</title>
                            ...
                            <div class="header p-1 text-light rounded-top d-flex justify-content-between"
                                ...
                                <div class="p-2 d-flex align-items-center gap-3">
                                    <div class="grid gap-3">
                                        <button data-toggle="modal" data-target="#modal_tambah_penanganan"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group col-sm-12 mb-0">
                                    ...
                                    <div class="">
                                        <input type="text" name="nama_penanganan" class="form-control" required
