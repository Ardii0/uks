    ...
    <div class="wrapper">
            ...
            <section class="content">
                ...
                <div class="modal fade" id="modal_tambah_program_kerja" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <form action="<?php echo base_url('Program_Kerja_UKS/aksi_tambah_program') ?>" enctype="multipart/form-data"
                            method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group col-sm-12 mb-0">
                                        ...
                                        <div class="custom-file mb-3">
                                            <input type="file" class="custom-file-input" id="customFile" name="foto" onchange="readURL(this);">
        ...
        <?php foreach ($program as $data): ?>
                <div class="modal fade" id="modal<?php echo $data->id ?>" tabindex="-1" role="dialog"
                    aria-labelledby="Modal" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <form action="<?php echo base_url('Program_Kerja_UKS/aksi_edit_program') ?>" enctype="multipart/form-data"
                            method="post">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group col-sm-12 mb-0">
                                        <label class="control-label">Nama Program</label>
                                        <div class="">
                                            <input type="text" name="nama_program" class="form-control mb-2" value="<?php echo $data->nama_program ?>" required autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-12 mb-0">
                                        <label class="control-label">Foto Program</label>
                                    ...
                                    <div class="form-group col-sm-12 mb-0">
                                        <label class="control-label">Tanggal Pelaksanaan</label>
                                        <div class="">
                                            <input type="datetime-local" name="tanggal" class="form-control"value="<?php echo $data->tanggal ?>"
                                                required><br>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-12 mb-0">
