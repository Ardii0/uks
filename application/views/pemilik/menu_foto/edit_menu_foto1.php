      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="box">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url('Pemilik/update_menu_foto1')?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
                  
                <div class="form-group col-sm-12 text-center"> 
                    <img style="width: 300px;height: 300px; " src="<?php echo base_url('uploads/admin/foto_frontend')."/".$row->foto1;?>" alt="">
                  </div>
                  <div class="form-group">
                    <label class="form-control-label">Ganti foto</label>
                    <input type="hidden" name="foto1_lama" value="<?php echo $row->foto1 ?>">
                    <input type="file" class="form-control"  name="foto1" required oninvalid="this.setCustomValidity('Tidak boleh kosong')" oninput="setCustomValidity('')">
                  </div>
