                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-header">
                            <center><b><h3 class="box-title">Laporan Pesanan</h3></b></center>
                            <div class="col s9">
                                <br/>
                                <a href="<?php echo base_url('Pemilik/export_laporan_pesanan') ?>" class="btn btn-warning">Export Data Pesanan</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
