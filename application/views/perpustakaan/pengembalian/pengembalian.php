        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <p style="font-size: 2rem">Pengembalian Buku</p>
                        </div>
                        <div class="col-sm-6">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a
                                                    href="<?php echo base_url('Perpustakaan/proses_peminjam_id/'.$data->id_pinjaman)?>">
                                                    <button type="button"
                                                        class="btn <?php $btn = $data->status == "DIPINJAM" ? 'btn-danger' : 'btn-success'; echo $btn ?> btn-sm"
                                                        <?php $btn = $data->status == "DIKEMBALIKAN" ? 'disabled' : ''; echo $btn ?>
                                                        style="width: 180px">
