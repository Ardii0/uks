                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-header">
                            <center><b><h3 class="box-title">Data Kategori Buku</h3></b></center>
                            <a href="<?php echo base_url('Admin/tambah_kategori_buku');?>" class="btn btn-success">Tambah Kategori Buku</a>
                            <br>  
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="table_1" class="table table-bordered table-striped">
                                ...
                                <?php $no=0; foreach($data_kategori_buku as $row ): $no++;?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('Admin/edit_kategori_buku/'.$row->id_kategori_buku)?>" class="btn btn-primary btn-sm">
                                            <i class="fa fa-edit"></i> Edit</a>
                                            <button onclick="hapus(<?php echo $row->id_kategori_buku?>)" class="btn btn-danger btn-sm">
