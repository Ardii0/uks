            ...
            <div class="col lp-layan">
                <div class="lp-lay">
                    <span class="d-md-flex" style="color:  #012269;"><span
                            style="color: #16A34A;">Layanan</span>&ensp;Kami</span>
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-4 lp-layout">
                <div class="lp-asis">
                    ...
                    <div class="col">
                        <p><a href="<?php echo base_url ('Akademik')?>"><i class="fa fa-check-circle"></i>Akademik</a>
                        </p>
                        <p><a href="<?php echo base_url ('Landingpage/daftar_buku')?>"><i
                                    class="fa fa-check-circle"></i>Perpustakaan</a></p>
                        <p><a href="<?php echo base_url ('Akademik/guru')?>"><i class="fa fa-check-circle"></i>Manajemen
                                Guru</a></p>
                    </div>
                    <div class="col">
