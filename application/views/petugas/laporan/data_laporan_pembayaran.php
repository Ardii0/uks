                ...
                <div class="col-sm-12">
                    <div class="box">
                        <div class="box-header">
                            <center><b><h3 class="box-title">Laporan Pembayaran</h3></b></center>  
                            <div class="col s9">
                                <br/>
                                <a href="<?php echo base_url('Admin/export_laporan_pembayaran') ?>" class="btn btn-warning">Export Data Pembayaran</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
<script>
    ...
    function konfirmasi_dp(id)
    {
        var yes=confirm('Konfirmasi Pembayaran?');
        if(yes == true)
        {
            window.location.href="<?php echo base_url('Admin/konfirmasi_dp/')?>"+"/"+id;
        }
    }

    function konfirmasi_pelunasan(id)
    {
        var yes=confirm('Konfirmasi Pembayaran?');
        if(yes == true)
        {
            window.location.href="<?php echo base_url('Admin/konfirmasi_pelunasan/')?>"+"/"+id;
        }
    }
