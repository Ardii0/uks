        ...
        <div class="col-sm-12">
          <div class="box">
            <div class="box-header">
              <center><b><h3 class="box-title">Tambah Konsumen</h3></b></center>
            </div>
            <!-- /.box-header -->
            <form action="<?php echo base_url('Admin/aksi_tambah_konsumen')?>" enctype="multipart/form-data" method="post">
              <div class="box-body">
