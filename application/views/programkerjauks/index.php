            ...
            <section class="content">
                                            ...
                                            foreach ($program as $data):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img style="width: 70px; height:100px; "
                                                            src="<?php echo base_url('uploads/programkerjauks/foto') . "/" . $data->foto; ?>">
                                                    </td>
                                                    <td>
                ...
                <div class="modal fade" id="modal_tambah_program_kerja" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <form action="<?php echo base_url('programkerjauks/aksi_tambah_program') ?>"
                ...
                <?php foreach ($program as $data): ?>
                    <div class="modal fade" id="modal<?php echo $data->id ?>" tabindex="-1" role="dialog"
                        aria-labelledby="Modal" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form action="<?php echo base_url('programkerjauks/aksi_edit_program') ?>"
                                enctype="multipart/form-data" method="post">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group col-sm-12 mb-0">
                                            ...
                                            <img src="<?php $img = $data->foto == null ? "" : base_url('uploads/programkerjauks/foto') . "/" . $data->foto;
