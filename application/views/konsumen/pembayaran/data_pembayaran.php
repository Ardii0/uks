                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Tahap Uang Muka (DP) <br> Rp. <?php echo $dt->dp_pw?></th>
                                    <th>
                                        <a href="<?php echo base_url('Konsumen/dp_pesanan/')?>" class="btn btn-primary btn-sm">
                                            <i class="fa fa-edit"></i>Bayar</a>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Tahap Pelunasan <br> Rp. <?php echo $dt->pelunasan_pw?></th>
                                    <th>
                                        <a href="<?php echo base_url('Konsumen/pelunasan_pesanan/')?>" class="btn btn-primary btn-sm">
                                            <i class="fa fa-edit"></i>Bayar</a>
                                    </th>
                                </tr>
                                </thead>
