      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="box">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url('Konsumen/konfirmasi_dp')?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
                <div class="form-group col-sm-12" hidden>
                  <label class="col-sm-2 control-label">Tagihan DP</label>
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $dt->dp_pw?>" name="bayar_dp" class="form-control" placeholder="Masukan Bayar"><br>
                  </div>
                </div>
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $dt->nama_bank_dp?>" name="nama_bank_dp" class="form-control" placeholder="Masukan Nama Bank"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">No Invoice</label>
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $dt->no_invoice_dp?>" name="no_invoice_dp" class="form-control" placeholder="Masukan No Invoice"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">Tanggal Bayar</label>
                  <div class="col-sm-10">
                    <input type="date" value="<?php echo $dt->tanggal_bayar_dp?>" name="tanggal_bayar_dp" class="form-control" placeholder="Masukan Tanggal Bayar"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                    <label class="col-sm-2 control-label">Unggah Bukti Pembayaran</label>
                    <div class="col-sm-10">
                      <input type="file" name="bukti_pembayaran_dp" class="form-control" placeholder="Masukan Bukti Pembayaran"><br>
                    </div>
                </div>
              </div>
                <!-- /.box-body -->
