      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="box">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form action="<?php echo base_url('Konsumen/aksi_tambah_pesanan')?>" method="post">
                <div class="box-body" hidden>
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $row->gambar_pw?>" name="gambar_pw" class="form-control" placeholder="Masukan Nama Gambar"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $row->pelunasan_pw?>" name="pelunasan_pw" class="form-control" placeholder="Masukan Harga"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $row->id_paket_wedding?>" name="id_paket_wedding" class="form-control" placeholder=""><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">Username</label>
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $dt->username?>" name="username" class="form-control" placeholder=""><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">Id Pemesan</label>
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $dt->id_admin?>" name="id_admin" class="form-control" placeholder=""><br>
                  </div>
                </div>
              </div>
              ...
              <div class="box-body">
                <div class="form-group col-sm-12">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama_pemesan" class="form-control" placeholder="Masukan Nama"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">Paket</label>
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $row->judul_pw?>" name="judul_pw" class="form-control" placeholder="Masukan Paket"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">Tanggal Acara</label>
                  <div class="col-sm-10">
                    <input type="date" name="tanggal_acara" class="form-control" placeholder="Masukan Tanggal Acara"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">No Telp</label>
                  <div class="col-sm-10">
                    <input type="text" name="no_telp_pemesan" class="form-control" placeholder="Masukan No Telp"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">Email</label>
                  <div class="col-sm-10">
                    <input type="text" name="email_pemesan" class="form-control" placeholder="Masukan Email"><br>
                  </div>
                </div>
                <div class="form-group col-sm-12">
                  <label class="col-sm-2 control-label">Alamat</label>
                  <div class="col-sm-10">
                    <input type="text" name="alamat_pemesan" class="form-control" placeholder="Masukan Alamat"><br>
                  </div>
                </div>
