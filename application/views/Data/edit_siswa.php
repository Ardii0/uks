                            ...
                            <form action="<?php echo base_url('data/ubah_siswa') ?>" method="post">
                                <div class="box-body">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-">
                                            <input type="text" value="<?php echo $datas->nama_siswa ?>" name="nama_siswa"
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-">
                                            <input type="text" value="<?php echo $datas->kelas ?>" name="kelas"
                                                class="form-control"><br>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-">
                                            <input type="text" value="<?php echo $datas->tempat_lahir ?>" name="tempat_lahir"
                                                class="form-control"><br>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-">
                                            <input type="date" value="<?php echo $datas->tanggal_lahir ?>" name="tanggal_lahir"
                                                class="form-control"><br>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-sm-">
                                            <input type="text" value="<?php echo $datas->alamat ?>" name="alamat"
                                                class="form-control" placeholder="Masukan Keterangan"><br>
                                        </div>
                                    </div>
                                </div>
