                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="<?php echo base_url('Akademik/tingkat') ?>">Tingkat</a></li>
            ...
            <section class="content">
                <div class="container-fluid bg-white py-4">
                    <?php foreach ($tingkat as $data): ?>
                        <form action="<?php echo base_url('Akademik/update_tingkat') ?>" enctype="multipart/form-data"
                            method="post">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" name="nama_tingkat" class="form-control"
                                                placeholder="Masukan Nama Tingkat" value="<?php echo $data->nama_tingkat ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                            ...
                            <div class="row d-flex justify-content-end">
                                <div class="">
                                    <input type="hidden" value="<?php echo $data->id_tingkat ?>" name="id_tingkat">
