...
class Datakaryawan extends CI_Controller {
    ...
    public function export_karyawan(){
        ...
        // Panggil function view yang ada di KaryawanModel untuk menampilkan semua data karyawannya
        $export_karyawan = $this->Main_model->export_karyawan();
        $no = 1; // Untuk penomoran tabel, di awal set dengan 1
        $numrow = 2; // Set baris pertama untuk isi tabel adalah baris ke 2
        foreach($export_karyawan as $data){ // Lakukan looping pada variabel karyawan
    ...
    public function export_periksa_karyawan()
    {
        ...
        // Set judul file excel nya
        $objPHPExcel->getActiveSheet(0)->setTitle("Periksa Karyawan");
        $objPHPExcel->setActiveSheetIndex(0);
        // Proses file excel
        header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
