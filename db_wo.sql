...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2023 at 05:21 PM
...
(1, 1, 1, 250000, 'Pembayaran SPP Maret', '2023-03-07 16:08:28', 'tu@gmail.com', NULL, NULL, 0);
...
ALTER TABLE `tabel_jenjang`
  ...
  ADD KEY `id_jenjang` (`id_jenjang`),
  ADD KEY `id_paketjenjang` (`id_paket`);
...
--
ALTER TABLE `tabel_alokasiguru`
  MODIFY `id_alokasiguru` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `tabel_alokasimapel`
--
ALTER TABLE `tabel_alokasimapel`
  MODIFY `id_alokasimapel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
