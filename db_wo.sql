...
CREATE TABLE `menu_paket` (
  `id_menu_paket` int(11) NOT NULL AUTO_INCREMENT,
...
(1,NULL,NULL,NULL,'admin','admin','202cb962ac59075b964b07152d234b70','09889928823','admin@gmail.com','laki-laki','Semarang',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,'2023-02-23 13:00:50','0000-00-00 00:00:00','0000-00-00 00:00:00','','','',1,'2023-02-23 13:00:50',1),
...
(12,NULL,NULL,NULL,'ada','ada','202cb962ac59075b964b07152d234b70',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,'2023-03-01 11:56:36','2023-02-20 11:26:01','2023-02-20 11:26:01','','','',1,'2023-03-01 11:56:36',5),
(13,NULL,NULL,NULL,'da','da','202cb962ac59075b964b07152d234b70',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,'2023-03-01 11:04:07','2023-02-20 11:26:01','2023-02-20 11:26:01','','','',1,'2023-03-01 11:04:07',4),
...
CREATE TABLE `tabel_alokasiguru` (
  `id_alokasiguru` int(11) NOT NULL AUTO_INCREMENT,
  `kode_guru` int(11) NOT NULL,
  `id_mapel` int(11) NOT NULL,
  PRIMARY KEY (`id_alokasiguru`),
  KEY `tabel_alokasiguru_to_mapel` (`id_mapel`),
...
CREATE TABLE `tabel_alokasimapel` (
  ...
  CONSTRAINT `tabel_alokasimapel_ibfk_1` FOREIGN KEY (`id_kelas`) REFERENCES `tabel_kelas` (`id_kelas`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `tabel_pembayaran_pelunasan` (
  `id_pembayaran_pelunasan` int(11) NOT NULL AUTO_INCREMENT,
  `id_admin` varchar(20) DEFAULT NULL,
  `id_pesanan` varchar(20) DEFAULT NULL,
  `id_paket_wedding` varchar(20) DEFAULT NULL,
  `nama_pemesan` varchar(100) DEFAULT NULL,
...
CREATE TABLE `tabel_rombel` (
  ...
  CONSTRAINT `tabel_guru_ibfk_1` FOREIGN KEY (`kode_guru`) REFERENCES `tabel_guru` (`kode_guru`),
